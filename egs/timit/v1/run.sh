...
train=/home/yangwenhao/local/project/lstm_speaker_verification/data/timit/pyfb/train_fb24_power
test=/home/yangwenhao/local/project/lstm_speaker_verification/data/timit/pyfb/test_fb24_power
datafrom=fb24_power
...
#py30 256 GMMs 128
#EER: 2.526%
#minDCF(p-target=0.01): 0.3989
#minDCF(p-target=0.001): 0.8946

#20200501
#py30 256 GMMs 128
#EER: 3.003%
#minDCF(p-target=0.01): 0.4636
#minDCF(p-target=0.001): 0.9244
...
#dpy24 with mean weight from var 256 GMMs 128
# train classifier weight
# EER: 2.963%
#minDCF(p-target=0.01): 0.4018
#minDCF(p-target=0.001): 0.6544
#test verification weight
# EER: 2.778%
